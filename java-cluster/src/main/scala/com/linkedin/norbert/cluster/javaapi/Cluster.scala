...
class ClusterConfig {
  ...
  /**
   * The <code>RouterFactory</code> the <code>ClusterClient</code> should use to generate <code>Router</code> instances.
...
/**
 * A bootstrap for creating a <code>ClusterClient</code> instance.
 *
...
class ClusterBootstrap(clusterConfig: ClusterConfig) {
  ...
  } with ZooKeeperClusterComponent with JavaRouterHelper
  ...
  /**
   * Retrieves the <code>ClusterClient</code> instance generated by the bootstrap.
   *
   * @return a <code>ClusterClient</code> instance.  The instance returned my not yet have finished
