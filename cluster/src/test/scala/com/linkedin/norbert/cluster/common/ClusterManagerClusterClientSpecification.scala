...
trait ClusterManagerClusterClientSpecification extends Specification with WaitFor {
  ...
  class TestClusterManager(protected val delegate: ClusterManagerDelegate) extends ClusterManager {
    def act {
  ...
  val clusterClient: ClusterManagerClusterClient

  def unconnectedExamples = {
