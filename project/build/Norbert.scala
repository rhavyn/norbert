...
class NorbertProject(info: ProjectInfo) extends ParentProject(info) {
  ...
  lazy val javaCluster = project("java-cluster", "Norbert Java Cluster", cluster)
  lazy val javaNetwork = project("java-network", "Norbert Java Network", javaCluster, network)
  lazy val examples = project("examples", "Norbert Examples", network, javaNetwork)
  ...
  class ClusterProject(info: ProjectInfo) extends DefaultProject(info) {
  ...
  class NetworkProject(info: ProjectInfo) extends DefaultProject(info) {
